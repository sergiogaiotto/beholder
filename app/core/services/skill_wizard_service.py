...
6. **Roteamento**: padrão Sabia-4 (Maritaca cloud) + Fallback openai/gpt-oss-20b (ClaroHub on-prem). Se o domínio exigir raciocínio complexo ou alto volume, use o ClaroHub como Default.
